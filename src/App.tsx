    ...
    <footer className="site-footer">
      <div className="footer-inner footer-top">
        ...
        <nav className="footer-links" aria-label="Links do rodapé">
          <a href="/solicitar-visita" className="footer-link" onClick={(e) => { e.preventDefault(); navigate("/solicitar-visita"); }}>
          ...
          <a href="/consultar" className="footer-link" onClick={(e) => { e.preventDefault(); navigate("/consultar"); }}>
          ...
          <a href="/seguranca" className="footer-link" onClick={(e) => { e.preventDefault(); navigate("/seguranca"); }}>
          ...
          <a href="/duvidas" className="footer-link" onClick={(e) => { e.preventDefault(); navigate("/duvidas"); }}>
